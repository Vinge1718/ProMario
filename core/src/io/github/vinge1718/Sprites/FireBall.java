...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / MyProgrammingMario.PPM, 6 / MyProgrammingMario.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /MyProgrammingMario.PPM : getX() - 12 /MyProgrammingMario.PPM, getY());
        ...
        shape.setRadius(3 / MyProgrammingMario.PPM);
        fdef.filter.categoryBits = MyProgrammingMario.FIREBALL_BIT;
